      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 border border-teal-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent"
          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-teal-600">Jl. Raya Ubud No. 123, Bali, Indonesia</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-teal-600">
                  ...
                  <div>
                    ...
                    <p className="text-teal-600">info@balitours.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-teal-600">
            ...
            {/* Social Media */}
            <div className="bg-teal-50 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-teal-800 mb-6">Follow Us</h3>
